...
def main():
    try:
        logging.basicConfig(filename='analytics.log', filemode='w', level=logging.DEBUG,
        ...
        print(e)
        r.send_message_to_slack("The report hasn't been created due to an error")
    else:
        r.send_message_to_slack("The report has been successfully created")
